...
imageTitle: Mengetahui Kecocokan Pasangan Hitungan Weton Jawa untuk Pernikahan
imageCaption: ''
status: published
seoTitle: Mengetahui Kecocokan Pasangan Hitungan Weton Jawa untuk Pernikahan
customBreadcrumbLabel: Mengetahui Kecocokan Pasangan Hitungan Weton Jawa untuk Pernikahan
canonicalUrl: >-
  https://acaranya.id/artikel/kecocokan-pasangan-hitungan-weton-jawa-untuk-pernikahan/
noindex: false
---
4.7/5 - (3 suara)
...
![tabel hitungan weton](/images/blog/content/tabel-hitungan-weton.jpg)

Tabel Hitungan Weton Jawa by Acaranya.id
...
> _Atau, kamu juga bisa menggunakan kalkulator cek weton online dari Acaranya.id **[DISINI](https://acaranya.id/cek-weton/)**._

**Contoh Kasus 1:**

*   **Pasangan A**:  
    Lahir pada hari **Rabu Pon**.
    *   Rabu = 7
    *   Pon = 7  
        Total **neptu** pasangan A = 7 (Rabu) + 7 (Pon) = **14**
*   **Pasangan B**:  
    Lahir pada hari **Jumat Wage**.
    *   Jumat = 6
    *   Wage = 4  
...
*   **Pasangan C**:  
    Lahir pada hari **Senin Kliwon**.
    *   Senin = 4
    *   Kliwon = 8  
        Total neptu pasangan C = 4 (Senin) + 8 (Kliwon) = **12**
*   **Pasangan D**:  
    Lahir pada hari **Minggu Pahing**.
    *   Minggu = 5
    *   Pahing = 9  
...
Pasangan yang memiliki total neptu 1, 9, 17, 25, atau 33 masuk ke dalam kategori **Pegat**. Menurut tradisi Jawa, pasangan ini diramalkan akan sering mengalami konflik besar yang bisa berujung pada perceraian (_pegat_).
